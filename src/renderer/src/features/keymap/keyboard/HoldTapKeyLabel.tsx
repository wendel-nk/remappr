...
export function HoldTapKeyLabel ( {
    ...
    return (
        <>
            <div
                className="key-tap-section flex items-center justify-center w-full flex-1 overflow-hidden border-b border-border/40 pt-2">
                <KeyLabel
            ...
            <div
                className="key-hold-section flex items-center justify-center w-full h-[40%] overflow-hidden bg-muted/40 text-muted-foreground">
                <KeyLabel
